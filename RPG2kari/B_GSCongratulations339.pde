...
class GameSceneCongratulations339 extends GameSceneCongratulationsBase {
  PShader sd;
  int startMillis;
  ...
  @Override void setup() {
    ...
    sd = loadShader("data/339/Shadertoy.glsl");
    sd.set("iResolution", (float)width, (float)height, 0.0f);
    // 最初のミリ秒を取り込んでおく
    startMillis = millis();
    sd.set("iChannel1", loadImage("data/339/iChannel1.png"));
  }
  @Override void draw() {
    push();
