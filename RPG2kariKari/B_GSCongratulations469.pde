...
class GameSceneCongratulations469 extends GameSceneCongratulationsBase {
  PShader sd;
  int startMillis;
  int startCount;
  ...
  @Override void setup() {
    ...
    sd = loadShader("data/469/Shadertoy.glsl");
    sd.set("iResolution", (float)width, (float)height, 0.0f);
    sd.set("iChannel0", loadImage("data/469/iChannel0.jpg"));
