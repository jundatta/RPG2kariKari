...
class GameSceneCongratulations458 extends GameSceneCongratulationsBase {
  PShader sd;
  int startMillis;
  int startCount;
  ...
  @Override void setup() {
    ...
    sd = loadShader("data/458/Shadertoy.glsl");
    sd.set("iResolution", (float)width, (float)height, 0.0f);
    sd.set("iChannel0", loadImage("data/458/iChannel0.jpg"));
    sd.set("iChannel1", loadImage("data/458/iChannel1.jpg"));
    sd.set("iChannel2", loadImage("data/458/iChannel2.png"));
    sd.set("iChannel3", loadImage("data/458/iChannel3.jpg"));
